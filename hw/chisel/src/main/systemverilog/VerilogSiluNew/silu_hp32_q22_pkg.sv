package silu_hp32_q22_pkg;
  ...
  localparam int STAGE0_WIDTH = 26;
  localparam int STAGE0_FRAC  = 16;
  localparam int STAGE1_MUL_WIDTH = 32;
  localparam int STAGE1_MUL_FRAC  = 22;
