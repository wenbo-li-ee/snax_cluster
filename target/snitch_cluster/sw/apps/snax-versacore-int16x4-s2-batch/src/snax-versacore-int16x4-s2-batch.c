// Int16x4 batch test — Mode 0 (SwiGLU) + Mode 1 (GEMM)
// Shape S2: array_shape=2 → (meshRow=2, tileSize=8, meshCol=16)
// M=1, K=2, N=2 (input token rows = M*meshRow = 2)
