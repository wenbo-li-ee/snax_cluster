...
def emit_header(params):
    ...
    arrays.append(emit_u8_array("W", packed_int4_constant(k0_s0_tiles * n0_tiles, 1)))
    arrays.append(emit_u8_array("V", packed_int4_constant(k0_s0_tiles * n0_tiles, 2)))
    arrays.append(emit_u8_array("W2_left", packed_int4_constant(k1_s0_tiles * n1_tiles, 1)))
    arrays.append(emit_u8_array("W2_right", packed_int4_constant(k1_s0_tiles * n1_tiles, 2)))
    ...
    return "\n".join([
        "#include <stdint.h>",
        "",
        "#ifndef SNAX_VERSACORE_INT16X4_MULTISHAPE_16X2_MODE0_SINGLE_WRITER_DATA_H",
        "#define SNAX_VERSACORE_INT16X4_MULTISHAPE_16X2_MODE0_SINGLE_WRITER_DATA_H",
        "",
        "#define NUM_SHAPES 3",
        "#define DATA_TYPE 0",
