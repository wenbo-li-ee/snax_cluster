...
def emit_dual_versacore_data(**kwargs):
    ...
    tiles_per_k = tileSize // meshCol  # = 2
    assert N % tiles_per_k == 0, f"N={N} not divisible by tiles_per_k={tiles_per_k}"
    assert N // tiles_per_k == K1, f"K1 mismatch: {N // tiles_per_k} vs {K1}"
