...
LAYOUTS = [
    {"id": 15, "name": "l15_padded_2048_per_token", "a_pad": 32,
...
def emit_header(params):
    ...
    return "\n".join([
        "#include <stdint.h>",
        "",
        "#ifndef SNAX_VERSACORE_INT16X4_MULTISHAPE_K8_8X4_MODE1_CONTIGUOUS_L15_DATA_H",
        "#define SNAX_VERSACORE_INT16X4_MULTISHAPE_K8_8X4_MODE1_CONTIGUOUS_L15_DATA_H",
        "",
